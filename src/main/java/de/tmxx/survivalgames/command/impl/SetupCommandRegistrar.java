 ...
 * @version 1.0
 */
public class SetupCommandRegistrar implements CommandRegistrar {
    ...
    @Inject
    public SetupCommandRegistrar(JavaPlugin plugin, @PluginLogger Logger logger) {
        this.plugin = plugin;
        this.logger = logger;
    }
    ...
    private void discoverSetupCommandsIfNotAlreadyDone() {
        ...
        commands.addAll(loadClasses(Setup.class, logger));
    }
}
